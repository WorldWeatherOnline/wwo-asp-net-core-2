...
namespace WorldWeatherOnline
{
	namespace SkiWeatherResponse
	{
		...
		public class NearestArea
		{
			...
			/// <summary>
			/// Distance, in miles, between the query longitude and latitude and the nearest area position.
			/// </summary>
		...
		public class HourlyObj
		{
			...
			/// <summary>
			/// Weather for top level
			/// </summary>
			public List<Hourly> top { get; set; }
			/// <summary>
			/// Weather for bottom level
			/// </summary>
			public List<Hourly> bottom { get; set; }
			/// <summary>
			/// Weather for mid level
			/// </summary>
			public List<Hourly> mid { get; set; }
		...
		/// <summary>
		/// collection of weathers for location
		/// </summary>
		public class WeatherObj {
			...
			/// <summary>
			/// weather at bottom level
			/// </summary>
			public List<Weather> bottom { get; set; }
			/// <summary>
			/// weather at mid level
			/// </summary>
			public List<Weather> mid { get; set; }
			/// <summary>
			/// Weather at top level
			/// </summary>
			public List<Weather> top { get; set; }
			/// <summary>
			/// Hourly weather conditions. 
			/// </summary>
			public List<HourlyObj> hourly { get; set; }
		}
